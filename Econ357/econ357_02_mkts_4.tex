...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/02_mkts_4_covid1.png}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/02_mkts_4_covid2.png}

\end{frame}

\begin{frame}[t]
    \frametitle{2. Market for Money}
    \section{Market for Money}
...
\begin{frame}[t]
    ...
    \includegraphics[width=0.8\textwidth]{Econ357/figures/02_mkts_4_mkt_money.png}
...
\begin{frame}[t]
    ...
    \setion{Money Supply and Inflation}
    \framesubtitle{}
    ...
    However, for the purposes of this class, we will assume that an increase in the money supply is accompanied by an expectation of a higher growth rate of money supply in the future, and, therefore, by higher inflation expectations.
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=\textwidth]{Econ357/figures/02_mkts_m3_cpi.png}

    \blfootnote{The actual relationship between the growth in the money supply and CPI is not especially tight, as you can see.   In Friedman's defense, money growth was higher in the 1970s, which coincided with a high inflation rate.}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/02_mkts_4_analysis1.png}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/02_mkts_4_analysis2.png}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/02_mkts_4_analysis3.png}
