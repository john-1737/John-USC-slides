...
\begin{frame}[t]
    \frametitle{3. Uses of P/E Ratios}
    \section{Uses of P/E Ratios}
    \framesubtitle{Comparing Sectors}

    \centering
    \includegraphics[width=\textwidth]{Econ357/figures/02_mkts_7_damadoaran.png}
...
\begin{frame}[t]
 ...
 \centering
    ...
    \blfootnote{Source: Wall Street Journal, February 2026}
...
\begin{frame}[t]
 ...
 \centering
    \includegraphics[width=0.4\textwidth]{Econ357/figures/02_mkts_7_banks.png}
...
\begin{frame}[t]
    ...
    \begin{table}[h]
        \centering
        \caption{PE Ratios of Automakers}
        \begin{tabular}{lrrrr}
            \toprule
...
\begin{frame}[t]
 ...
 \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/02_mkts_7_jpm.png}

    \blfootnote{Source: JP Morgan Asset Management, Guide to the Markets, January 2025}
