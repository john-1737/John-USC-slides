...
\usepackage{makecell}       % Multiline tables

% Supress Table in Captions
\usepackage{caption} % load once in preamble
...
\newenvironment{practiceframe}[1][t]{%
    ...
    % -------- Compact settings start here --------
    \footnotesize
    \setlength{\parskip}{0pt}
    \setlength{\baselineskip}{0.96\baselineskip}

    % Compact lists (this is the key part)
