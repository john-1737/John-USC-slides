...
\begin{frame}[t]
    ...
    \textbf{Office Hours:} \\
    Location: KAP 304\\
    Time: Thursdays, 1:00 - 2:00 pm pm\\
...
\begin{frame}[t]
    ...
    \vspace{-1em}
        ...
        \midrule
        Intro & 1  & Financial Sectors, Intermediaries \\
...
\begin{frame}[t]
    ...
    Brightspace: Lecture slides, reading assignments, announcements, Zoom recordings, and electronic version of the textbook\\
    
    \vspace{1em}
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/Intro_brightspace.png}
