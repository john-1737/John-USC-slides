...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=\textwidth]{Econ357/figures/05_gfc_2_fedfunds.png}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=\textwidth]{Econ357/figures/05_gfc_2_ca.png}

    \blfootnote{Source: IMF, https://www.imf.org/external/datamapper/BCA_NGDPD/WEO/DEU/CHN/SAU/USA}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.6\textwidth]{Econ357/figures/05_gfc_2_underwater.png}

    \blfootnote{Source: Federal Reserve, https://www.federalreserve.gov/pubs/feds/2008/200859/200859pap.pdf}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/05_gfc_2_bankleverage.png}

    \blfootnote{Source: IMF, https://www.imf.org/external/pubs/ft/wp/2010/wp1044.pdf}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=\textwidth]{Econ357/figures/05_gfc_2_banklosses.png}

    \blfootnote{Source: Boston Fed, http://business.cch.com/BANKD/Fed-Boston-Research-Paper-07162013.pdf} 
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/05_gfc_2_shadowbanking_1.png}


    \blfootnote{Source: Metrick and Geithner, Coursera}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/05_gfc_2_shadowbanking_2.png}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=\textwidth]{Econ357/figures/05_gfc_2_shadowbanking_3.png}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/05_gfc_2_shadowbanking_4.png}
...
\begin{frame}[t]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{Econ357/figures/05_gfc_2_shadowbanking_5.png}
...
\begin{frame}[t]
    ...
    \begin{column}{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Econ357/figures/05_gfc_2_derivatives.png}
    \end{column}
...
\framesubtitle{Regulators}
    ...
    \begin{itemize}
        ...
        \item Fed Chair Alan Greenspan was adamant that the market would regulate itself:
    \end{itemize}   
    \vspace{3em}

    \myquote{"With notably rare exceptions (2008, for example), the global “invisible hand” has created relatively stable exchange rates, interest rates, prices, and wage rates."}
    {Alan Greespan}
