...
\begin{frame}[t]
    ...
    \section{GDP}
    \framesubtitle{GDP - Short Term}

    \centering
    \includegraphics[width=0.9\textwidth]{Econ457/figures/Intro_gdp_shortterm.png}

    \blfootnote{Source: Bureau of Economics Analysis, FRED}

\end{frame}

\begin{frame}[t]
    \frametitle{3. Some Interesting Charts}
    \framesubtitle{GDP - Long Term}
...
\begin{frame}[t]
    \frametitle{3. Some Interesting Charts}
    \section{Safe Assets}
    \framesubtitle{Safe Assets - Short Term}

    \centering
    \includegraphics[width=0.9\textwidth]{Econ457/figures/Intro_safe_shortterm.png}

    \blfootnote{Source: Board of Governors, FRED}
...
\begin{frame}[t]
    ...
    \framesubtitle{Risky Assets - Stocks}

    \centering
    \includegraphics[width=0.9\textwidth]{Econ457/figures/Intro_sptr.png}

    \blfootnote{Source: Google Finance}

\end{frame}

\begin{frame}[t]
    \frametitle{3. Some Interesting Charts}
    \framesubtitle{Risky Assets - Housing}

    \centering
    \includegraphics[width=0.9\textwidth]{Econ457/figures/Intro_caseshiller.png}

    \blfootnote{Source: S\&P Dow Jones Indices LLC via FRED}

\end{frame}

\begin{frame}[t]
    \frametitle{3. Some Interesting Charts}
    \framesubtitle{Risky Assets - Long Term}
