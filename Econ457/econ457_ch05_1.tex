...
\begin{frame}[t]
    ...
    The Annual Percentage Rate of Return (APR) is a convention often used for short term instruments.   For example, for a credit card with monthly compounding, each monthly payment is equal to the APR divided by twelve.  The APR does not itself account for the effect of compounding, it is only used to determine the size of the monthly payments. 
...
\begin{frame}[t]
    \frametitle{3. Measuring returns}
    \framesubtitle{Geometric v. Arithmetic Mean}
