...
\begin{foundframe}
    ...
    \blfootnote{See the foundation material on the normal distribution from lecture \#3.   You actually don't need the normality assumption for the property on this slide to be true.}
...
\begin{frame}[t]
    ...
    The \textbf{Capital Allocation Line (CAL)}  depicts all possible combinations in risk-return space available from this decision.\\
    \vspace{1em}
    \begin{itemize}
