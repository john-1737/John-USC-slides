...
\begin{frame}[t]
    ...
    \vspace{1em}
    The expected return of your porfolio is $E[r_p] = wr_{risky} + (1+w)r_f$.   The standard deviation of your portfolio is $\sigma_p = w\sigma_{risky}$.   The fact that $\sigma_{r_f} = 0$ simplifies the standard deviation term.
    \vspace{1em}
