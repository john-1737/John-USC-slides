...
\begin{frame}[t]
    ...
    \vspace{1em}
    The expected return of your portfolio is $E[r_p] = wE[r_{risky}] + (1-w)r_f$.   The standard deviation of your portfolio is $\sigma_p = w\sigma_{risky}$.   The fact that $\sigma_{r_f} = 0$ simplifies the standard deviation term.
    \vspace{1em}
...
\begin{frame}[t]
    ...
    \item When $w=1$, the portfolio is entirely invested in the risky asset with $E[r_p] = E[r_{risky}]$ and $\sigma_p = \sigma_{risky}$. The CAL thus goes through and goes the point $(x=\sigma_{risky},y=E[r_{risky}])$
    \end{itemize}
