...
\begin{frame}
    ...
    \begin{enumerate}
        \item Optimal Portfolio: SPY, TLT and Cash
        \item Optimal Portfolio: General Case
...
\begin{frame}[t]
    \frametitle{1. Optimal Portfolio: SPY, TLT, and Cash}
...
\begin{frame}[t]
    \frametitle{1. Optimal Portfolio: SPY, TLT, and Cash}
    \framesubtitle{Define the optimization problem}

    Start by finding the optimal combination of SPY and TLT.   Once we have that, the problem is the same as the capital allocation problems we did last week.
    \vspace{1em}
    The optimal combination of SPY and TLT will be the one that maximizes the Sharpe Ratio:
