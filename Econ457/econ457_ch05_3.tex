...
\begin{frame}[t]
    ...
    \begin{enumerate}
      ...
      \item Construct a price series first, then adjust to get real values.   In most cases you can also use a total return series, like the one you created in homework, and after a similar adjustment you would have the "real" value of an investment in that asset.   
    \end{enumerate}
