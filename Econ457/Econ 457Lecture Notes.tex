...
\section{Ch 9: CAPM}
    ...
    \begin{shaded}
        ...
        \begin{enumerate}
            ...
            \begin{align*}
                \text{Dividend Return} = 6/50 = 12\%\\
                \text{Expected Return} = 18\%\\
                \text{Capital Gain} = 6\%\\
                \text{Price at end of year} = \$53\\
            \end{align*}

            \item Assuming no change in the expectations for dividends or the end of year price, if you are offered the stock for \$48 what should you do?   If you receive a bid for the stock at \$54 what should you do?

            \textit{Buy at \$48, sell at \$54.}
    ...
    \begin{shaded}
        ...
        \begin{enumerate}
            ...
            \begin{align*}
                E[r_A] &= -2*0.5 + 38*0.5 = 18 \\
                E[r_D] &= 6*0.5 + 12*0.5 = 9\\
                E[r_M] &= 5*0.5 + 25*0.5 = 15\\
            \end{align*}
            \item What is the Var-Cov matrix, if the two scenarios are equally likely?
            \begin{align*}
                Var[r_A] &= 0.5(-20)^2 + 0.5(20)^2 = 400 \\
                Var[r_D] &= 0.5(3)^2 + 0.5(3)^2 = 9\\
                Var[r_M] &= 0.5(10)^2 + 0.5(10)^2 = 100\\
                Cov(r_A,r_M) = 0.5(20)(10) + 0.5(20)(10) = 200\\
                Cov(r_A,r_D) = 20*3 = 60\\
                Cov(r_D,r_M) = 10*3 = 30\\
            \end{align*}
            \item What are the betas of the aggressive and defensive stock?
                \begin{align*}
                    \beta_A =  \frac{Cov(r_A,r_M)}{Var(r_M)} = \frac{200}{100} = 2\\
                    \beta_D =  \frac{Cov(r_D,r_M)}{Var(r_M)} = \frac{30}{100} = 0.3\\
                \end{align*}
            ...
            \begin{align*}
                    A_{SML} = 6+2*9 = 24 \implies \text{A is below the SML}\\
                    D_{SML} = 6+0.3*9 = 8.7 \implies \text{D is slightly above to the SML}\\
                \end{align*}
