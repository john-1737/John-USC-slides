...
\section{Lecture 2: Measurement}
   ...
   \textit{ Arithmetic average = $0\%$
    ...
    If the natural log of a total return series increase by 1 point over a 2-year period, what is the HPR for that period?   What is the EAR?\\
    \vspace{1em}
    $$ln{\frac{P_2}{P_0}} = 1$$
    Exponential of both sides
    $$\frac{P_2}{P_0} = e$$
    $$HPR = e - 1 = 171\%$$
    $$EAR = \sqrt{1+1.71} - 1 = 64.9\%$$
    \end{shaded}
  ...
  \end{shaded}
    ...
    \subsection{Practice: Annualizing Returns}
      ...
      \setcounter{enumi}{0}
        ...
        $$\sigma = \sqrt{40}\cddot10 = 6.32\cdot10 = 63.2$$
